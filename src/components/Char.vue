  ...
  <div class="glyph">
    ...
    <div class="glyph-box">
      <h2>
        ...
        <button class="copy" title="Copy to clipboard" data-clipboard-target="#glyph">
          <i class="copy-icon"><span class="sr-only">Copy</span></i>
        </button>
      </h2>
    </div>
      ...
      <div id="h" class="tab-panel">
        <div class="codes">
          ...
          <div v-for="(entity, i) in html(glyph)" :key="i" class="code">
            ...
            <button class="copy" title="Copy to clipboard" :data-clipboard-target="`#html-code-${i}`">
              <i class="copy-icon"><span class="sr-only">Copy</span></i>
            </button>
          </div>
        </div>
        <div class="examples">
          ...
          <div v-for="(entity, i) in html(glyph)" :key="i" class="example">
            ...
            <button class="copy" title="Copy to clipboard" :data-clipboard-target="`#html-example-${i}`">
              <i class="copy-icon"><span class="sr-only">Copy</span></i>
            </button>
          </div>
        </div>
      ...
      <div id="c" class="tab-panel">
        <div class="codes">
          ...
          <div v-for="(code, i) in css(glyph)" :key="i" class="code">
            ...
            <button class="copy" title="Copy to clipboard" :data-clipboard-target="`#css-code-${i}`">
              <i class="copy-icon"><span class="sr-only">Copy</span></i>
            </button>
          </div>
        </div>
        <div class="examples">
          ...
          <div v-for="(code, i) in css(glyph)" :key="i" class="example">
            ...
            <button class="copy" title="Copy to clipboard" :data-clipboard-target="`#css-example-${i}`">
              <i class="copy-icon"><span class="sr-only">Copy</span></i>
            </button>
          </div>
        </div>
      ...
      <div id="j" class="tab-panel">
        <div class="codes">
          ...
          <div class="code">
            ...
            <button class="copy" title="Copy to clipboard" data-clipboard-target="#js-code-0">
              <i class="copy-icon"><span class="sr-only">Copy</span></i>
            </button>
          </div>
          <div class="code">
            <pre id="js-code-1">{{ js(glyph) }}</pre>
            <button class="copy" title="Copy to clipboard" data-clipboard-target="#js-code-1">
              <i class="copy-icon"><span class="sr-only">Copy</span></i>
            </button>
          </div>
        </div>
        <div class="examples">
          ...
          <div class="example">
            ...
            <button class="copy" title="Copy to clipboard" data-clipboard-target="#js-example-0">
              <i class="copy-icon"><span class="sr-only">Copy</span></i>
            </button>
          </div>
          <div class="example">
            <pre id="js-example-1" class="js">let s = "<span>{{ js(glyph) }}</span>";</pre>
            <button class="copy" title="Copy to clipboard" data-clipboard-target="#js-example-1">
              <i class="copy-icon"><span class="sr-only">Copy</span></i>
            </button>
          </div>
        </div>
      ...
      <div id="u" class="tab-panel">
        <div class="codes">
          ...
          <div class="code">
            ...
            <button class="copy" title="Copy to clipboard" data-clipboard-target="#hex-code">
              <i class="copy-icon"><span class="sr-only">Copy</span></i>
            </button>
          </div>
        </div>
        <div class="examples">
          ...
          <div class="code">
            ...
            <button class="copy" title="Copy to clipboard" data-clipboard-target="#decimal-code">
              <i class="copy-icon"><span class="sr-only">Copy</span></i>
            </button>
          </div>
        </div>
