<template>
  <div class="splash">
    ...
    <ul class="tips">
      <li>Searching <strong>{{ count.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',') }}</strong> glyphs from the <a href="http://unicode.org/versions/Unicode13.0.0/">Unicode 13.0.0</a> standard</li>
