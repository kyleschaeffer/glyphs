...
exports.default = _default;
  ...
  return _c("div", { staticClass: "glyph" }, [
    _c(
      "button",
      {
        staticClass: "close",
    ...
    _vm._v(" "),
    _c("h1", [_vm._v(_vm._s(_vm.glyph.name))]),
    _vm._v(" "),
    _c("h2", [_c("span", [_vm._v(_vm._s(_vm.glyph.char))])]),
    _vm._v(" "),
    _c("div", { staticClass: "codes" }, [
      _c("div", { staticClass: "unicode" }, [
        _c("h3", [_vm._v("Unicode:")]),
        _vm._v(" "),
        _c("pre", [_vm._v(_vm._s(_vm.glyph.hex))])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "html" }, [
        _c("h3", [_vm._v("HTML:")]),
        _vm._v(" "),
        _c("pre", [_vm._v(_vm._s(_vm.html(_vm.glyph)))])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "js" }, [
        _c("h3", [_vm._v("JavaScript:")]),
        _vm._v(" "),
        _c("pre", [_vm._v("\\u" + _vm._s(_vm.glyph.hex))])
      ])
    ])
  ])
}
...
},{"vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/Colophon.vue":[function(require,module,exports) {
        ...
        return _c(
          "button",
          {
            ...
            on: {
              click: function($event) {
                $event.preventDefault()
                return _vm.$emit("glyph-select", result.char)
              }
            }
          },
          [
            _c("span", { staticClass: "hex" }, [_vm._v(_vm._s(result.hex))]),
            _c("span", {
              staticClass: "glyph-char",
              domProps: { innerHTML: _vm._s(result.char) }
            })
          ]
        )
      }),
...
var _default = {
  ...
  async mounted() {
    // Get glyph data
    try {
      const glyphs = await _axios.default.get('glyphs/utf.json');
      this.fuse = _fuse.default.init(glyphs.data.chars);
    } catch (e) {
      console.error(e);
    } // Load state
...
},{"timers":"node_modules/timers-browserify/main.js","axios":"node_modules/axios/index.js","./Char.vue":"src/components/Char.vue","./Colophon.vue":"src/components/Colophon.vue","../fuse":"src/fuse.js","./Glyphs.vue":"src/components/Glyphs.vue","query-string":"node_modules/query-string/index.js","./Search.vue":"src/components/Search.vue","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/app.js":[function(require,module,exports) {
"use strict";
